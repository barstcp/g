...
import com.example.perm.perm_rest_union.view.fragments.MainFragment;
import com.example.perm.perm_rest_union.view.fragments.TestFragment;
...
public class Main extends AppCompatActivity
    ...
    private void replaceFragment(Fragment fragment, boolean addBackStack) {
        ...
        transaction.replace(R.id.container, fragment, "test");
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.menu_blud) {

        } else if (id == R.id.zakazat) {
